...
func igoFile(f os.FileInfo) bool /* ignore non-iGo files */ {
	name := f.Name()
...
func igoParse(fset *token.FileSet, filename string, src []byte) (*ast.File, func(orig, src []byte) []byte, error) /* Try as whole source file. */ {
